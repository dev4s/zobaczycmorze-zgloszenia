...
def polish_plural(
    count: int, singular: str, plural_2_4: str, plural_5_plus: str
) -> str:
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if total > 0:
            ...
            if zgloszenia:
                parts.append(
                    polish_plural(zgloszenia, "zgloszenie", "zgloszenia", "zgloszen")
                )
            if wachty:
            ...
            if ogloszenia:
                parts.append(
                    polish_plural(ogloszenia, "ogloszenie", "ogloszenia", "ogloszen")
                )
        ...
        self.stdout.write("")
        self.stdout.write(
            "Nastepny krok: Uruchom 'poe createsuperuser' aby utworzyc konto administratora."
        )
        self.stdout.write("")
